...
export default function Home() {
  ...
  const translations = {
    ...
    it: {
      ...
      heroSubtitle: "TechFront potenzia la tua azienda con soluzioni tecnologiche all'avanguardia progettate per la crescita e l'efficienza.",
      discoverButton: 'Scopri le Nostre Soluzioni',
      requestDemoButton: 'Richiedi una Demo',
      aboutTitle: 'Informazioni su TechFront',
