...
export default function Home() {
  ...
  const translations = {
    en: {
      ...
      missionText: 'To be the trusted technology partner that turns complexity into clarity, delivering scalable and AI-driven solutions',
      visionTitle: 'Our Vision',
      visionText: 'To be the leading partner with forward-thinking businesses, co-creating agile digital solutions that drive efficiency, innovation, and lasting value.',
    ...
    es: {
      ...
      missionText: 'Ser el socio tecnológico de confianza que convierte la complejidad en claridad, entregando soluciones escalables e impulsadas por IA.',
      visionTitle: 'Nuestra visión',
      visionText: 'Ser el socio líder de empresas con visión de futuro, co-creando soluciones digitales ágiles que impulsan la eficiencia, la innovación y el valor duradero.',
    ...
    it: {
      ...
      missionText: "Essere il partner tecnologico di fiducia che trasforma la complessità in chiarezza, fornendo soluzioni scalabili e guidate dall'IA.",
      visionTitle: 'La Nostra Visione',
      visionText: "Essere il partner principale per aziende lungimiranti, co-creando soluzioni digitali agili che guidano efficienza, innovazione e valore duraturo.",
